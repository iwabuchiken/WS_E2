...
CapSense_CONFIG_TYPE_P4_v2_20 CapSense_config;
CapSense_CONFIG_TYPE_POINTERS_P4_v2_20 const CapSense_configPointers = {
...
void CapSense_AutoTune(void)
{
    ...
    CalibrateSensors_P4_v2_20(&CapSense_config, CapSense_CAL_RAW_COUNT);
    ...
    TunePrescalers_P4_v2_20(&CapSense_config);
    ...
    CalibrateSensors_P4_v2_20(&CapSense_config, CapSense_CAL_RAW_COUNT);
		...
		CapSense_NormalizeWidgets(CapSense_END_OF_WIDGETS_INDEX, CapSense_modulationIDAC);
	#endif /* (0u != CapSense_TOTAL_CENTROIDS_COUNT)  */
    TuneSensitivity_P4_v2_20(&CapSense_config);
...
void CapSense_UpdateThresholds(uint32 sensor)
{
	...
	widget = CapSense_widgetNumber[sensor];
		...
		CalculateThresholds_P4_v2_20(&CapSense_config, (uint8)sensor, CapSense_sensorRaw, (uint8)widget, CapSense_fingerThreshold, CapSense_noiseThreshold);
